...
test('malformed package.json', { skip: !fs.existsSync(malformedDir) }, function (t) {
    ...
    var res2 = resolve.sync(
        './index.js',
        {
            ...
            readPackageSync: function (readFileSync, pkgfile) {
                t.equal(pkgfile, path.join(basedir, 'package.json'), 'readPackageSync: `pkgfile` is package.json Options",
      "message": "Beta"
   },
   ...
   "blacklistclickmessage": {
      ...
      "message": "Rechtsklick auf eine Werbung auf einer Seite, um sie zu blockieren – oder hier manuell blockieren."
   },
   "bla